...
from ..game import GameState, replace
from ..ansi import (
    RESET, BOLD, DIM,
    gold_fg, white_fg, light_gray_fg, green_fg, red_fg,
    ansi_center, banner_bg, banner_fg, clear_screen, hide_cursor,
)
...
from ..stats import load_stats, get_session_stats
...
def show_stats(reader: KeyReader) -> None:
    ...
    while True:
        ...
        worst = stats.worst_round_score if stats.worst_round_score < 200 else 0
