...
from belote.gameflow import run_bidding, run_play, create_ai_players
from belote.game import GameState, Phase, Seat, start_round, new_game
...
def test_run_play_8_tricks():
    ...
    with unittest.mock.patch('belote.gameflow.display'), \
        ...
        ai_players = create_ai_players({s: "easy" for s in Seat}, human_seats)
